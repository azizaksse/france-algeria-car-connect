...
const Footer = () => {
  ...
  const openingHours = [
    { day: language === 'fr' ? 'Mardi' : 'الثلاثاء', hours: '10:00 - 19:00' },
    { day: language === 'fr' ? 'Mercredi' : 'الأربعاء', hours: '10:00 - 19:00' },
    { day: language === 'fr' ? 'Jeudi' : 'الخميس', hours: '10:00 - 19:00' },
    { day: language === 'fr' ? 'Vendredi' : 'الجمعة', hours: '10:00 - 19:00' },
    { day: language === 'fr' ? 'Samedi' : 'السبت', hours: '10:00 - 19:00' },
    { day: language === 'fr' ? 'Dimanche' : 'الأحد', hours: '10:00 - 18:00' },
    { day: language === 'fr' ? 'Lundi' : 'الإثنين', hours: '10:00 - 19:00' },
  ];
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@aa.auto.export?_r=1&_t=ZN-92O992pJ23y"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-accent rounded-full flex items-center justify-center hover:bg-accent/80 transition-colors"
                  aria-label="TikTok"
                >
                  <svg className="w-5 h-5 text-accent-foreground" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.86-.6-4.12-1.31a6.417 6.417 0 0 1-1.56-1.17v6.28c-.02 2.34-.17 4.71-1.61 6.7a9.074 9.074 0 0 1-2.9 2.63c-2.35 1.28-5.14 1.35-7.69.54-2.1-.67-3.99-2.23-5.05-4.18A9.234 9.234 0 0 1 0 14.55c.02-3.53 2.04-7.03 5.27-8.45 1.35-.6 2.83-.87 4.3-.76v4.3c-.81-.11-1.66-.01-2.41.31-1.03.43-1.84 1.29-2.26 2.33-.46 1.13-.14 2.51.74 3.35.62.6 1.54.88 2.38.73.84-.15 1.51-.77 1.84-1.55.3-.71.31-1.49.3-2.25V0h2.45z" />
                  </svg>
                </a>
                {/* WhatsApp */}
                <a
