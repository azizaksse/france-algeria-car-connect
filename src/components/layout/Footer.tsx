...
const Footer = () => {
  ...
  const quickLinks = [
    { label: language === 'fr' ? 'Accueil' : 'الرئيسية', path: '/' },
    { label: language === 'fr' ? 'Véhicules neufs' : 'سيارات جديدة', path: '/vehicles?category=new' },
    { label: language === 'fr' ? "Véhicules d'occasion" : 'سيارات مستعملة', path: '/vehicles?category=used' },
    { label: language === 'fr' ? 'À propos' : 'من نحن', path: '/about' },
    { label: 'FAQ', path: '/#faq' },
    { label: language === 'fr' ? 'Nous contacter' : 'اتصل بنا', path: '/contact' },
  ];
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  ...
                  <span>contact@aaautoexport.com</span>
                </a>
              </li>
              <li>
                <a 
              ...
              <li>
                ...
                >
                  ...
                  <span>18 Bis Voie de Mons, 94290 Villeneuve-le-Roi</span>
                </a>
              </li>
            </ul>
          </div>
