...
export const translations = {
  fr: {
    ...
    hero: {
      title: 'Exporter votre véhicule de France vers l\'Algérie',
      subtitle: 'en toute confiance.',
      description: 'Nous vous accompagnons dans l\'achat et l\'exportation de votre véhicule depuis la France vers l\'Algérie. Transparence, expertise et service personnalisé.',
    ...
    services: {
      ...
      items: [
        ...
        { title: 'Transport & Export', description: 'Logistique maritime et terrestre vers l\'Algérie.' },
        { title: 'Livraison en Algérie', description: 'Réception de votre véhicule dans la wilaya de votre choix.' },
      ],
    },
    vehicles: {
      title: 'Nos Véhicules',
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { number: '04', title: 'Livraison en Algérie', description: 'Réception de votre véhicule dans votre wilaya sous 2 à 4 semaines.' },
      ],
    },
    whyUs: {
      ...
      items: [
        { title: 'Expertise France–Algérie', description: 'Plus de 10 ans d\'expérience dans l\'export automobile.' },
    ...
    footer: {
      description: 'Votre partenaire de confiance pour l\'exportation de véhicules de France vers l\'Algérie.',
      links: 'Liens rapides',
  ...
  ar: {
    ...
    hero: {
      title: 'نصدّر سيارتك من فرنسا إلى الجزائر',
      subtitle: 'بكل ثقة وشفافية',
      description: 'نرافقك في شراء وتصدير سيارتك من فرنسا إلى الجزائر. شفافية وخبرة وخدمة شخصية.',
      cta1: 'عرض السيارات',
      cta2: 'طلب عرض أسعار',
    },
    services: {
      ...
      items: [
        ...
        { title: 'النقل والتصدير', description: 'الخدمات اللوجستية البحرية والبرية إلى الجزائر.' },
        { title: 'التسليم في الجزائر', description: 'استلام سيارتك في الولاية التي تختارها.' },
      ],
    },
    vehicles: {
      title: 'سياراتنا',
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { number: '04', title: 'التسليم في الجزائر', description: 'استلام سيارتك في ولايتك خلال 2 إلى 4 أسابيع.' },
      ],
    },
    whyUs: {
      title: 'لماذا تختارنا',
      ...
      items: [
        { title: 'خبرة فرنسا-الجزائر', description: 'أكثر من 10 سنوات من الخبرة في تصدير السيارات.' },
    ...
    form: {
      ...
      wilaya: 'ولاية التسليم',
      message: 'الرسالة',
      submit: 'إرسال الطلب',
      success: 'تم استلام طلبك بنجاح. سنتواصل معك في أقرب وقت ممكن.',
    },
    footer: {
      description: 'شريكك الموثوق لتصدير السيارات من فرنسا إلى الجزائر.',
      links: 'روابط سريعة',
